...
public class Home {
    ...
    public Home(RemoteWebDriver driver2) {
        this.driver = driver2;
    }
        ...
        try {
            ...
            for (WebElement parentElement : parentElements) {
                ...
                if (actualProductName.equals(productName)) {
                    ...
                    while (true) {
                        WebElement currentqtyElement = parentElement
                        ...
                        if (quantity > currentQty) {
                            ...
                            wait.until(ExpectedConditions.textToBePresentInElement(parentElement.findElement(By.xpath("//div[@data-testid='item-qty']")),
