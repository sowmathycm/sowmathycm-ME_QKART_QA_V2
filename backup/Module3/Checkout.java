...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
            ...
            for(int i=0; i<addressElements.size();i++){
                WebElement addElement = addressElements.get(i);
                String actualAddressText = addElement.getText();
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            ...
            Thread.sleep(2000);
            WebElement insufficient = driver.findElement(By.xpath("//div[@class='SnackbarItem-wrappedRoot css-vbcata']//div[@id='notistack-snackbar']"));
            String instext = insufficient.getText();
