...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[contains(@class,'1qw96cp')]//child::p[1]"), product),
            //  ExpectedConditions.presenceOfElementLocated(By.tagName("h4"))));
            //  //Thread.sleep(3000);
            ExpectedCondition con1 = ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("//h4[contains(text(), 'No products found')]"));
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//div[@class='MuiBox-root css-zgtx0t']/div[2]")).getText().split("\n")[0]);
            }
